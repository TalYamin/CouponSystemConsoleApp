...
public class ScenarioTests {
	...
	public static void companyTest() {
		...
		try {
			...
			companyUser2.insertCoupon(new Coupon(17, "Gilboa Trip", "31/12/2019", 15, CouponType.TRAVELING,
					"traveling in Gilboa Mountain", 1000,
					"https://upload.wikimedia.org/wikipedia/he/c/c9/%D7%92%D7%9C%D7%91%D7%95%D7%A2.JPG"));
	...
	public static void dailyTaskTest() {
		...
		try {
			...
			companyUser3.insertCoupon(new Coupon(23, "Metzada", "1/1/2019", 2, CouponType.TRAVELING, "Metzada Trip",
					500,
					"https://new.goisrael.com/he/sites/default/files/styles/1397x735_article_full/public/Massada%201397X735_2.jpg?itok=B_e3i_G1"));
