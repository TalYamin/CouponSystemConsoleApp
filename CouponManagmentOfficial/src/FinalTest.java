...
public class FinalTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			companyUser.insertCoupon(new Coupon(12, "BBB", "31/5/2019", 5, CouponType.RESTAURANTS, "dinner for couple", 70.3, "https://images1.calcalist.co.il/PicServer2/20122005/522772/YE1218528_l.jpg"));
			...
			companyUser.insertCoupon(new Coupon(14, "Goons Pizza", "31/12/2019", 5, CouponType.RESTAURANTS, "family pizza", 60.7, "https://lh3.googleusercontent.com/p/AF1QipMHRbrkD5FglAreY6ZtKzZYBeee-t4OsmupQNKn=s1600-w1280-h1280"));
			...
			companyUser.insertCoupon(new Coupon(15, "BBB", "31/12/2019", 5, CouponType.RESTAURANTS, "breakfast for couple", 50.5, "https://media-cdn.tripadvisor.com/media/photo-s/07/14/8a/20/enjoy.jpg"));
			
			//(12) try to add coupon with date that already passed
			System.out.println("*************************************");
			System.out.println("(12) Try to add coupon with date that already passed: ");
			companyUser.insertCoupon(new Coupon(16, "Cafe Cafe", "1/1/2012", 5, CouponType.RESTAURANTS, "breakfast for couple", 50.5, "https://media-cdn.tripadvisor.com/media/photo-s/07/14/8a/20/enjoy.jpg"));
		...
		try {
			...
			companyUser3.insertCoupon(new Coupon(21, "Falafel Moosa", "1/1/2019", 5, CouponType.RESTAURANTS, "falafel for couple", 50, "http://www.10bis.co.il/ImageViewer.aspx?imgName=4195&imgDir=ResProfile"));
			companyUser3.insertCoupon(new Coupon(22, "Sushi", "1/2/2019", 10, CouponType.RESTAURANTS, "Sushi meal", 25, "http://images.saloona.co.il/tadmit11/files/2017/07/76bkg4n0im664qrktf82.jpg"));
